<div align="justify">
 <div align="center">
  <img src="/docs/assets/termux-screenshot.jpg">
...
git clone https://github.com/connerwill/dotfiles   \
  && docker run                                    \
    ...
    -it                                            \
    archlinux                                      \
    sh -c "ln -rs ~/.config/zsh/.zshenv ~/ && pacman -Sy --noconfirm zsh tmux git fzf bat lsd termux && chsh --shell /usr/bin/zsh && exec zsh"
```
