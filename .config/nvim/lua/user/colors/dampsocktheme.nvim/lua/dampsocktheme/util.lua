local hsluv = require("dampsocktheme.hsluv")
...
-- local ns = vim.api.nvim_create_namespace("dampsocktheme")
...
function util.debug(colors)
  colors = colors or require("dampsocktheme.colors")
  -- Dump unused colors
...
function util.onColorScheme()
  if vim.g.colors_name ~= "dampsocktheme" then
    vim.cmd([[autocmd! DampSockTheme]])
    vim.cmd([[augroup! DampSockTheme]])
  end
end
...
function util.autocmds(config)
  vim.cmd([[augroup DampSockTheme]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("dampsocktheme.util").onColorScheme()]])
  if config.dev then
    vim.cmd([[  autocmd BufWritePost */lua/dampsocktheme/** nested colorscheme dampsocktheme]])
  end
...
function util.load(theme)
  ...
  vim.g.colors_name = "dampsocktheme"
