#!/usr/bin/env bash
# vim:ft=zsh:fileencoding=utf-8:foldmethod=marker:foldmarker=###{{{,###}}}:shiftwidth=2:nowrap
###{{{
# ====================CONFIG THIS =============================== #
export COLOR_01="#15161E"           # Black
...
export CURSOR_COLOR="#CF00FF" # Cursor color
export PROFILE_NAME="_zsh"
# =============================================================== #
#}}}
# =============================================================== #
# | Apply Colors
...
BASE_URL=${BASE_URL:-"https://raw.githubusercontent.com/ConnerWill/Dotfiles/main"}
