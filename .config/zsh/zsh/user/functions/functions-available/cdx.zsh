# shellcheck ignore 1072
# shellcheck ignore 2148
...
if [[ -n "$NVIMDIR" ]]; then
	if [[ -d "$NVIMDIR" ]]; then
		...
		alias cdv-="cdz $NVIMDIR"
		alias cdv-u="cdz $NVIMDIR/lua/user"
		alias cdv-l="cdz $NVIMDIR/lua/user/lsp"
		alias cdv-s="cdz $NVIMDIR/lua/user/luasnippets"
		alias cdv-lo="cdz $NVIMDIR/.nvim-localshare"
		alias cdv-go="cdz $NVIMDIR/.nvim-globalshare"
		alias cdv-c="cdz $NVIMDIR/lua/user/colors"
		alias cdv-e="$EDITOR $NVIMDIR/lua/user"
	fi
fi
...
#   [[ -z "$_Destination" ]] \
#     && local _Destination="$ZDOTDIR"
#
#   [[ ! -d "$_Destination" ]] \
#     && printf '\e[0;38;5;196mCannot move to:\t"\e[0;1;3;38;5;226m%s\e[0;3;38;5;196m"\e[0m\n' "$_Destination" \
#       && return 1
#
# 	cd "$_Destination" \
#     && printf '\e[0;38;5;82mMoved to:\t"\e[0;1;38;5;226m%s\e[0;38;5;82m"\e[0m\n' "$_Destination" \
