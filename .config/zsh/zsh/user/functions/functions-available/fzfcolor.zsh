...
function fzfcolor () {
   ...
   STRING_HEADER="    "
    ...
    COLOR_FG='#323A5C' COLOR_FGP='#00FFFF'        COLOR_PREVIEW_FG='#C0CAF5' COLOR_PREVIEW_BG='#202646'
    COLOR_BORDER='#8800EE' COLOR_INFO='#00FFFF'   COLOR_HL='#CF04FA'         COLOR_HLP='#53FFAD'
    COLOR_PROMPT='#AA00FF' COLOR_HEADER='#0077FF' COLOR_POINTER='#53FFAD'    COLOR_MARKER='#00FF00'
    ...
    # size=${#array[@]} index=$((RANDOM % size)) COLOR_SCHEME=${array[$index]}
