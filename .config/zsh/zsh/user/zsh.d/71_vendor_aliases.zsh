...
if [[ "${commands[lsd]}" ]]; then
    ...
    alias lls="printf '\e[0;1;38;5;93m🌚🌚\e[0;1;3;4;38;5;199mThis could take a while...\e[0m\e[0;1;38;5;93m🌚🌚\e[0m\t'; date +'%Y%m%d_%H%M%S'; lsd --long --sort=size --header --color=always --total-size --date=+'%Y%m%d%H%M%S' --almost-all --dereference --blocks 'size,date,name' --reverse --permission octal 2>/dev/null"
