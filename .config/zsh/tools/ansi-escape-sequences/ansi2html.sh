...
It has 2 optional parameters:
   ...
   --bg=dark
   --palette=linux|solarized|tango|xterm


EXAMPLES

  $ ls -l --color=always | ansi2html.sh --bg=dark > ls.html

  $ ls --color=always --all --long | ./ansi2html.sh > index.html && python -m http.server & xdg-open "http://localhost:8000"
