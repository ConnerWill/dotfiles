...
default_screen_capture_path="$XDG_CACHE_HOME/tmux/tmux-screenshots"
...
[[ ! -d "$screen_capture_path" ]] && mkdir -v -p "$screen_capture_path"
...
default_save_complete_history_path="$XDG_CACHE_HOME/tmux/tmux-history"
...
[[ ! -d "$save_complete_history_path" ]] && mkdir -v -p "$save_complete_history_path"
